...
const MatchUseCase_1 = require("../business/usecases/User/MatchUseCase");
const UserDatabase_1 = require("../data/User/UserDatabase");
function MatchEndpoint(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const useCase = new MatchUseCase_1.MatchUseCase(userGateway);
...
exports.MatchEndpoint = MatchEndpoint;
;
