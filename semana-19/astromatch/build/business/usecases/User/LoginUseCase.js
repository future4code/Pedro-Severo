...
class LoginUseCase {
    constructor(userGateway, cryptographyGateway, userTokenGateway) {
    ...
    execute(input) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const comparedPassword = yield this.cryptographyGateway.compare(input.password, user.getPassword());
            if (!comparedPassword) {
