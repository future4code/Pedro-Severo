...
export class SwipeScreen extends Component {
	...
	componentDidMount() {
		if (!this.props.profile && this.props.getProfileToSwipe) {
	...
	onChooseOption = (option) => () => {
		...
		if (this.props.profile) {
			this.props.chooseProfile(this.props.profile.id, option === 'like')
		}
		this.props.getProfile()
	}

	render() {
		const {goToMatchScreen, profile} = this.props
