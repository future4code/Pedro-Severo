...
while (querJogar) {
  ...
  if (querJogar === true) {  
    ...
    //Arrays indicando a mão e os valores de cada carta dos jogadores. Aqui precisa ser acrescentado novas cartas e valores a cada novo saque. 
    ...
    for (let cartaAtualComputador of maoComputador) {
      somaDasCartasComputador += cartaAtualComputador
    }
